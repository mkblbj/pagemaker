    ...
    if 'usage.get' in interface_id:
        ...
        if usage_result is not None:
            data = {
                ...
                'avail_space': _safe_float(_get_element_text(usage_result, 'AvailSpace')),
                'use_folder_count': _safe_int(_get_element_text(usage_result, 'UseFolderCount')),
                'avail_folder_count': _safe_int(_get_element_text(usage_result, 'AvailFolderCount')),
            }
        ...
        if folders_result is not None:
            data = {
                'result_code': _safe_int(_get_element_text(folders_result, 'resultCode')),
                'folder_all_count': _safe_int(_get_element_text(folders_result, 'folderAllCount')),
                'folder_count': _safe_int(_get_element_text(folders_result, 'folderCount')),
        ...
        files_result = root.find('cabinetFolderFilesGetResult') or root.find('cabinetFilesSearchResult')
        if files_result is not None:
            data = {
                'result_code': _safe_int(_get_element_text(files_result, 'resultCode')),
                'file_all_count': _safe_int(_get_element_text(files_result, 'fileAllCount')),
...
def map_http_status_to_exception(status_code: int, response_text: str = "") -> Exception:
    """
    将HTTP状态码映射为对应的异常
...
def map_result_code_to_exception(result_code: int, interface_id: str = "") -> Optional[Exception]:
    """
