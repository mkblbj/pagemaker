...
class UserProfile(models.Model):
    ...
    role = models.CharField(
        max_length=10, choices=ROLE_CHOICES, default="editor", verbose_name=_("角色")
    )

    full_name = models.CharField(max_length=100, blank=True, verbose_name=_("全名"))
...
def get_user_profile(user):
    ...
    try:
        ...
        return UserProfile.objects.create(
            user=user, role=role, full_name=user.get_full_name() or ""
        )
