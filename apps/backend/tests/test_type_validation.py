...
from pagemaker.schemas import (
    UserModel, UserRole, PageModuleModel, PageModuleType,
    PageTemplateModel, ShopConfigurationModel,
    ApiResponse, PaginatedResponse
)
from pagemaker.validators import (
    TypeValidator, PydanticValidator,
    create_api_response, create_paginated_response
)
...
class TestEnumCompatibility:
    ...
    def test_page_module_type_enum_values(self):
        ...
        # 验证所有枚举值
        expected_types = {
            "title", "text", "image", "separator", "keyValue", "multiColumn"
        }
