...
class ShopConfiguration(models.Model):
    ...
    id = models.UUIDField(
        primary_key=True, default=uuid.uuid4, editable=False, help_text="唯一标识符"
    )
    shop_name = models.CharField(max_length=100, help_text="用户可识别的店铺名称")
    ...
    ftp_port = models.IntegerField(default=21, help_text="FTP服务器端口")
    ftp_user = models.CharField(max_length=100, help_text="FTP用户名")
    ftp_password = models.CharField(max_length=255, help_text="FTP密码")
