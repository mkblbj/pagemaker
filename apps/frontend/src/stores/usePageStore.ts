      ...
      addModule: module =>
        set(
          state => {
            ...
            const modules = Array.isArray(state.currentPage.content) ? [...state.currentPage.content, module] : [module]
      ...
      deleteModule: moduleId =>
        set(
          state => {
            ...
            const modules = state.currentPage.content.filter((module: PageModule) => module.id !== moduleId)
