  ...
  return (
    <Card className="w-full max-w-md">
      ...
      <CardContent className="space-y-4">
        <div>
          <p className="text-sm text-muted-foreground">ahooks counter: {count}</p>
        ...
        <div>
          <p className="text-sm text-muted-foreground">Shared-types test: {mockApiResponse.data?.username}</p>
        </div>
      </CardContent>
    </Card>
  )
